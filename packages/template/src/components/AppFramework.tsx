  ...
  return (
    <section className="section">
      <div className="section-title">
        <h2>应用框架与插件</h2>
        <span className="num-font">Karin runtime</span>
      </div>
      <div className="app-grid">
        <div className="app-card app-card--icon">
          ...
          <div className="app-content">
            <div className="app-title num-font">运行版本</div>
            <div className="app-value num-font">{data.runtimeVersion}</div>
          </div>
        </div>
        <div className="app-card app-card--icon">
          ...
          <div className="app-content">
            <div className="app-title num-font">已连接Bot</div>
            <div className="app-value num-font">{data.mountedBots}</div>
          </div>
        </div>
      </div>
      <div className="plugin-chips">
        {Object.entries(pluginTypeStyles).map(([key, style]) => {
          const value = key === 'total' ? data.plugins.total : data.plugins[key as keyof typeof data.plugins]
          return (
